namespace Day09
{
    internal class Program
    {
        static void Main(string[] args) {
            ...
            Console.WriteLine($"(Part 2) Unique tail points visited: {part2.Distinct().Count()}");
        }

        static List<(int x, int y)> GetTailMovements(IEnumerable<string> input, int knotCount) {
